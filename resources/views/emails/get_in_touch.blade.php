...
{{--                <a href="https://www.paceconnect.co.ke/" style="color:Black;border:0;outline:0" target="_blank">--}}
                <a href="#" style="color:Black;border:0;outline:0" target="_blank">
                    <span style="color:green;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:24px;text-decoration: none;">
                        <b><h2>Nexcom</h2> </b></span>
                </a>
            </td>
        </tr>
        </tbody>
                    ...
                    <table class="m_-6590733290487731973ecxconversation-part m_-6590733290487731973ecxuser" style="/*! /*! border-collapse:separate; */ */border-spacing:0;font-size:12px;line-height:18px" cellspacing="0" cellpadding="0" border="0" align="center">
                        ...
                        <tr>
                            <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:17px;font-weight:normal;color:#676767;padding:0;vertical-align:top;text-align:Left;line-height:40px" valign="top">
                                ...
                                I am in need of Internet services:
                                <ul>
                                    <li>Name: {{ $data['name'] }}</li>
                                    <li>Email: {{ $data['email'] }}</li>
                                    <li>Phone No: {{ $data['tel'] }}</li>
                                    <li>Region: {{ $data['region'] }}</li>
                                    <li>Apartment: {{ $data['apartment'] }}</li>
                                    <li>Road: {{ $data['road'] }}</li>
                                </ul>
                        ...
                        <tr>
                            <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:17px;color:#676767;padding:0;vertical-align:top;text-align:Left;line-height:40px" valign="top">
                                From <strong>{{ $data['name'] .'('. $data['email'].')' }}</strong>,
                            </td>
                        </tr>
                        <tr>
                            <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:17px;font-weight:normal;color:#676767;padding:30px 0 20px;vertical-align:top;line-height:40px" valign="top">
                                If this email was not intented for you, please disregard this email
                            </td>
                        </tr>
                        </tbody>
                    </table>
    ...
    <table style="background:#323c41;font-size:12px;height:70px;max-width:600px;width:100%;border-collapse:collapse" cellspacing="0" cellpadding="0" border="0" bgcolor="#333C41" align="center">
        <tbody>
        <tr>
            <td style="color:#bcbcbc;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:normal;height:30px;padding:20px 0 20px 20px;vertical-align:middle;line-height:1.2" valign="middle">
                Made by
                <a href="http://nexcom.co.ke/" style="text-decoration:none" target="_blank">Nexcom</a>
            </td>
        </tr>
        </tbody>
    </table>
