            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="bradcaump__inner text-center breadi">
                        ...
                        <p class="bradcaump-p"><a href="{{ url('/nexcom') }}"> Home</a> > <a href="{{ url('/FAQs') }}"> FAQs</a> > Technical Issues</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div id="accordion" class="panora_accordion pr-lg-5 pl-lg-5" role="tablist">
                        <div class="section__title text-left pb-2">
                            <h2 style="font-size: 25px !important;color: #545454">Technical Issues </h2>
                        </div>
                        <div class="card">
