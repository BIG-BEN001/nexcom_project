            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="bradcaump__inner text-center breadi">
                        ...
                        <p class="bradcaump-p"><a href="{{ url('/nexcom') }}"> Home</a> <  <a href="{{ url('/FAQs') }}"> FAQs</a> > General</p>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div id="accordion" class="panora_accordion pr-lg-5 pl-lg-5" role="tablist">
                        <div class="section__title text-left pb-2">
                            <h2 style="font-size: 25px !important;color: #545454">General </h2>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    This is a premium service that gives you unlimited access to seamless fast and reliable broadband
                                    internet.
                        ...
                        <div class="card">
                            <div class="acc-header" role="tab" id="five">
                                <h5>
                                    <a class="collapsed" data-toggle="collapse" href="#collapseFive" role="button" aria-expanded="false" aria-controls="collapseFive">
                                        How do I get assistance in case I have queries, issues or complaints?</a>
                                </h5>
                            </div>
                            <div id="collapseFive" class="collapse" role="tabpanel" aria-labelledby="five" data-parent="#accordion">
                                <div class="card-body">
                                    For assistance, please call: <br>  <span class="font-weight-bold">  +254 20 232 5599 or +254 700 583 417 </span><br>
                                    Alternatively, you can send an email to: <br><span class="font-weight-bold">  sales@directcore.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
